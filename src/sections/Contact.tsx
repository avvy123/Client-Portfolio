    ...
    >
      <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 text-gray-600 dark:text-gray-300">
              ...
              <div>
                ...
                <p className="font-semibold">+91 7301249218 </p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <form onSubmit={handleSubmit(onSubmit)} className="bg-white dark:bg-gray-800/80 p-8 rounded-2xl border border-gray-100 dark:border-gray-700/50 shadow-lg relative overflow-hidden">
            {isSuccess && (
              <motion.div 
